...
import { VibeDashboardPage } from '@/modules/vibe-dashboard';
import { EditorPage } from '@/modules/editor';
import { SiteRendererPage } from '@/modules/renderer';
        ...
        <ThemeProvider>
          <SidebarProvider>
            <Routes>
              ...
              {/* Editor — full-screen, auth-protected, no sidebar layout */}
              <Route
              ...
              {/* Live site renderer — fully public, no auth required */}
              <Route path="/site/:userId/:slug" element={<SiteRendererPage />} />
